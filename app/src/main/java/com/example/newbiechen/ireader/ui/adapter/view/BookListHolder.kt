...
class BookListHolder : ViewHolderImpl<BookListBean>() {
    ...
    override fun onBind(value: BookListBean, pos: Int) {
        //头像
        ...
        //简介
        mTvBrief.text = value.desc
        //信息
        mTvMsg.text = App.getInstance().getString(R.string.nb_fragment_book_list_message,
                value.bookCount, value.collectorCount)
    }
